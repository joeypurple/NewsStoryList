...
public class QueryUtils {
    ...
    /**
     * Create a private constructor because no one should ever creatae a {@link QueryUtils} object.
    ...
    public static List<Story> fetchStoryData(String requestUrl) {
        ...
        //Extract relevant fields from the JSON response and create a list of {@link Story}ies
        List<Story> stories = extractFeatureFromJson(jsonResponse);

        //Return the list of {@link Story}ies
        return stories;
    }

    /**
     * Returns new URL object from the fiven string URL
     */
    ...
    /**
     * Make an Http reuqest to the given URl and return a String as the response
     */
    ...
    /**
     * Return a list of {@link Story} objects that has been bulit up from parsing
    ...
    private static List<Story> extractFeatureFromJson(String storyJSON) {
        ...
        /**
         * Try to parse the JSon Response String. If theres a problem with the way the JSON is
         * formatted, a JSCONException exception will be thrown.
         * Catch the exception so the app doesnt crash and print the error msg to the logs.
         *
         */
        try {
            ...
            //Which respresents a list of stories
            ...
            for (int i = 0; i < storyArray.length(); i++) {
                 ...
                 * called "results", which represents a list of all the results for
                 * that story
                 */
               // JSONObject results = currentStory.getJSONObject("results");
                ...
                Story story = new Story(title, category, time, url);

...
public class StoryActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Story>> {
    ...
    // URL for the story data from the guardian dataset
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set the adapter on the {@link ListView} so it can be populated in the UI
        storyListView.setAdapter(mAdapter);

        /**
         * Set an item click listener on the ListView, which sends an intent to a web browser
         * to open a website with more information about selected story
         */
    ...
    public void onLoadFinished(Loader<List<Story>> loader, List<Story> stories) {
        //Hide loading indicator bc the data has been loaded
        View loadingIndicator = findViewById(R.id.loading_indicator);
        loadingIndicator.setVisibility(View.GONE);
        ...
        //If there is a valid list of {@link Story}ies then add them to the adapters
